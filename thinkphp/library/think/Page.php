...
//                    $link_page .= '<span class="current">' . $page . '</span>';
                    $link_page .= '<a class="active" tabindex="0" data-dt-idx="1" aria-controls="example1" href="#">' . $page . '</a>';
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        // "<div class='dataTables_paginate paging_simple_numbers'><ul class='pagination'>{$page_str}</ul></div>";
        return "<div class='container page'>{$page_str}</div>";
    }
}
