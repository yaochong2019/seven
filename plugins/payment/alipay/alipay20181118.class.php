...
{    
    ...
    {         
            ...
            $sign  = substr($sign, 0, -1). trim($this->alipay_config['key']);
            ...
            !$body && $body = "JHshop商品" ;
            $parameter = array(
                        "service" => 'create_direct_pay_by_user',// $service[$this->alipay_config['alipay_pay_method']],   // 1 使用担保交易接口  2 使用即时到帐交易接口 
                        "partner" => trim($this->alipay_config['partner']),
                        "seller_email" => trim($this->alipay_config['seller_email']),
