<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view/goods/countryList.html";i:1524190144;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
      ...
      <div class="tDiv">
        <div class="tDiv2">
          ...
          <div class="fbutton">
            <a href="<?php echo U('Goods/addEditCountry'); ?>">
              <div title="新增分类" class="add">
                <span><i class="fa fa-plus"></i>新增区域分类</span>
              </div>
            </a>  
          </div>
      <!--    <div class="fbutton">
      ...
      <div style="height: auto;" class="bDiv" id="flexigrid"  data-url="<?php echo U('Goods/delGoodsCountry'); ?>">
          ...
          <tr data-level="<?php echo $vo[level]; ?>" parent_id_path ="<?php echo $vo['parent_id_path']; ?>" class="parent_id_<?php echo $vo['parent_id']; ?>" nctype="0" <?php if($vo[level] > 1): ?> style="display:none;"<?php endif; ?>>
              ...
              <td class="handle">
                <div style="text-align:center;   min-width:150px !important; max-width:inherit !important;">
                  ...
                  <ul>
                    <li><a href="<?php echo U('Goods/addEditCountry',array('id'=>$vo['id'])); ?>">编辑分类信息</a></li>                  
                    <!--<li><a href="<?php echo U('Goods/addEditCountry',array('parent_id'=>$vo['id'])); ?>">新增下级分类</a></li>-->
              ...
              <td class="name">
                <div style="text-align: center; width: 200px;">
                  <input type="text" value="<?php echo $vo['name']; ?>" onblur="changeTableVal('goods_country','id','<?php echo $vo['id']; ?>','name',this)" style="text-align: left; width:180px;"/>
                </div>
              </td>
                <td align="center" class="">
                  <div style="text-align: center; width: 80px;">
                    <?php if($vo[is_show] == 1): ?>
                      <span class="yes" onclick="changeTableVal('goods_country','id','<?php echo $vo['id']; ?>','is_show',this)" ><i class="fa fa-check-circle"></i>是</span>
                      <?php else: ?>
                      <span class="no" onclick="changeTableVal('goods_country','id','<?php echo $vo['id']; ?>','is_show',this)" ><i class="fa fa-ban"></i>否</span>
                    <?php endif; ?>
                  </div>
                </td>  
              <td class="sort">
                <div style="text-align: center; width: 60px;">
                  <input type="text" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onblur="changeTableVal('goods_country','id','<?php echo $vo['id']; ?>','sort_order',this)" size="4" value="<?php echo $vo['sort_order']; ?>" />
                </div>
              </td>                                          
