<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view/order/delivery_info.html";i:1543391218;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
 ...
 <form id="delivery-form" action="<?php echo U('Admin/order/deliveryHandle'); ?>" method="post">
     ...
     <input type="hidden" id="shipping_name" name="shipping_name" value="<?php echo $order['shipping_name']; ?>">
      ...
      <div class="tabs-panels">
        ...
        <div class="addr-note">
          ...
          <dl>
            <dt>关区代码：</dt>
            <dd>
              <select name="customs" id="customs">
                <option value="3105">北仑保税区</option>
                <option value="3115">空港保税物流中心</option>
                <option value="3109">栎社机场</option>
                <option value="3117">梅山保税区</option>
                <option value="3113">慈溪保税区</option>
              </select>
            </dd>
            <dt>保价费：</dt>
            <dd><input class="input-txt" name="hg[InsuranceFee]" id="InsuranceFee" value="0" >
            </dd>
            <dt>税额：</dt>
            <dd><input class="input-txt" name="hg[TaxAmount]" id="TaxAmount" value="0" >
            </dd>
          </dl>

          <dl>
            <dt>关税额：</dt>
            <dd><input class="input-txt" name="hg[TariffAmount]" id="TariffAmount" value="0" >
            </dd>
            <dt>增值税额：</dt>
            <dd><input class="input-txt" name="hg[AddedValueTaxAmount]" id="AddedValueTaxAmount" value="0" >
            </dd>
            <dt>消费税额：</dt>
            <dd><input class="input-txt" name="hg[ConsumptionDutyAmount]" id="ConsumptionDutyAmount" value="0" >
            </dd>
          </dl>

          <dl>
            <dt>订购人身份证号：</dt>
            <dd><input class="input-txt" name="hg[BuyerIdnum]" id="BuyerIdnum" value="<?php echo $users['usercode']; ?>" >
            </dd>
            <dt>订购人姓名：</dt>
            <dd><input class="input-txt" name="hg[BuyerName]" id="BuyerName" value="<?php echo $order['consignee']; ?>" >
            </dd>
            <dt>消费税额：</dt>
            <dd><input class="input-txt" name="hg[ConsumptionDutyAmount]" id="ConsumptionDutyAmount" value="0" >
            </dd>
          ...
          <dt>配送方式：</dt>
                <dd><select id="shipping_code" name="shipping_code" onchange="set_shipping_name()">
                  <?php if(is_array($shipping_list) || $shipping_list instanceof \think\Collection || $shipping_list instanceof \think\Paginator): $i = 0; $__LIST__ = $shipping_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shipping): $mod = ($i % 2 );++$i;?>
                     <option <?php if($order[shipping_code] == $shipping[code]): ?>selected<?php endif; ?> value="<?php echo $shipping['name']; ?>" ><?php echo $shipping['name']; ?></option>
