<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"./application/admin/view/goods/ajax_spec_select.html";i:1528077548;}*/ ?>
...
{		
	...
	$.ajax({
			...
			url:"/Admin/Goods/ajaxGetSpecInput/goods_id/"+goods_id,
