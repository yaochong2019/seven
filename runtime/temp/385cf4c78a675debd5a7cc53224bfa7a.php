<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/order/index.html";i:1543388188;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
	        	<tr>
	              ...
	              </th>				<th class="">	                <div style="text-align: left; width: 30;" class="">国内国外</div>	              </th>
...
<script type="text/javascript">
    ...
    function ajax_get_table(tab,page){
        cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/Admin/order/ajaxindex/p/"+page,//+tab,
