<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"./template/pc/jinghui/index/forgetPassword.html";i:1542297264;s:40:"./template/pc/jinghui/public/header.html";i:1542287950;s:40:"./template/pc/jinghui/public/footer.html";i:1534148398;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    function reg_go() {
        ...
        $.post("<?php echo U('Index/doforgetpass'); ?>",{nickname:nickname,usercode:usercode,username:username,code:code,check_phone:check_phone,password:password,password2:password2,scene:scene},function (res) {
            console.log(res);
            layer.msg(res.msg);
			$(".tips").text(res.msg);
            if(res.status == 1){
