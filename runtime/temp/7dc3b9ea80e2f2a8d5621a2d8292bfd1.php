<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/pc/jinghui/user/login.html";i:1542523096;s:40:"./template/pc/jinghui/public/header.html";i:1542287950;s:40:"./template/pc/jinghui/public/footer.html";i:1534148398;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
			...
			<div class="login-tab">
				...
				<div class="tab-cont">
					<form class="form">
						...
						<div class="form-item">
							<input type="button" onclick="location.href='<?php echo U('reg'); ?>'" value="注册" class="btn btn-default">
						</div>
						<div class="form-item last-item">
							...
							<a class="forgetPassword" href="<?php echo U('Index/forgetPassword'); ?>">忘记密码？</a>
						</div>
					</form>
				</div>
			</div>
