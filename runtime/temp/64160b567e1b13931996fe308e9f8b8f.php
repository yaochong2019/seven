<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/admin/view/admin/login.html";i:1524190144;}*/ ?>
<!doctype html>
...
<body>
	<div class="login-layout">
    	<div class="logo"><img src="__PUBLIC__/static/images/logo.png"></div>
    ...
    <div id="bannerBox">
        <ul id="slideBanner" class="slideBanner">
            <li><img src="__PUBLIC__/static/images/banner_2.jpg" width="100%"></li>       
        </ul>
    </div>
