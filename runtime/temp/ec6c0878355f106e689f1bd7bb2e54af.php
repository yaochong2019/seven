<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"./template/pc/jinghui/goods/search.html";i:1526700040;s:40:"./template/pc/jinghui/public/header.html";i:1542287950;s:40:"./template/pc/jinghui/public/footer.html";i:1534148398;}*/ ?>
<!DOCTYPE html>
	...
	<div class="product-cate">
		...
		<div class="cate-item cate-item-brand">
			...
			<div class="cate-item-list">
				...
				<a class="no-condition active" href="<?php echo U('Home/Goods/search',array('q'=>$filter_param['q'])); ?>">不限</a>
		...
		<div class="cate-item cate-item-brand">
			...
			<div class="cate-item-name"><span>价格：</span></div>

			<div class="cate-item-list">

				<a href="<?php echo U('Home/Goods/search',array('q'=>$filter_param['q'])); ?>">不限</a>
				...
				<a href="<?php echo $v[href]; ?>" data-href="<?php echo $v[href]; ?>" data-key='<?php echo $v[key]; ?>' data-val='<?php echo $v[val]; ?>'><?php echo $v[value]; ?></a>
...
<div class="container">
	...
	<div class="product-list">
		...
		<?php if(empty($goods_list) || (($goods_list instanceof \think\Collection || $goods_list instanceof \think\Paginator ) && $goods_list->isEmpty())): ?>
			...
			<p class="text" style="font-size: 16px;margin:100px auto;text-align: center;">-- 抱歉没找到您要搜索的商品！--</p>
