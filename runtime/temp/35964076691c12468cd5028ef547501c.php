...
<div class="person-news">
    ...
    <div class="item" onclick="location.href='<?php echo U('detail',array('article_id'=>$vo[article_id])); ?>'">
        <h4><span><?php echo date('Y-m-d',$vo[publish_time]); ?></span> <?php echo $vo[title]; ?></h4>
        <div class="content">
            <!--<?php if($v[thumb]): ?>-->
