<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./template/pc/jinghui/goods/timeLimitShop.html";i:1543379056;s:40:"./template/pc/jinghui/public/header.html";i:1542287950;s:40:"./template/pc/jinghui/public/footer.html";i:1534148398;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container clearfix">
        ...
        <div class="item">
            ...
            <div>
                ...
                <div class="date"><?php echo $time['front']; ?></div>
        ...
        <div class="item active">
            ...
            <div>
                ...
                <div class="date"><?php echo $time['now']; ?></div>
        ...
        <div class="item">
            ...
            <div>
                ...
                <div class="date"><?php echo $time['after']; ?></div>
        ...
        <div class="cont special-product-scroll">
            ...
            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                ...
                <div class="swiper-slide list-item time">
                    ...
                    <a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$vo[goods_id])); ?>" style="padding-bottom: 0px;">

                        <div class="img">

                            <img src="<?php echo goods_thum_images($vo[goods_id],200,200); ?>" alt="">
                    ...
                    <div class="product-name">
                        ...
                        <?php echo getSubstr($vo[goods_name],0,15); ?>

                    </div>

                    <div style="width: 100%;padding: 0 12px;" >

                    <span class="reference-price" style="text-decoration: line-through;">￥<?php echo $vo['shop_price']; ?></span>

                    </div>

                    <div class="product-handle" style="margin-bottom: 20px;">

                        <span class="price" style="margin-left: 0;">￥<i style="font-size:20px!important;"><?php echo number_format($vo[price],2); ?></i></span>

                        <div class="add-cart" style="margin-right: 0;">

                            <a style="float:right;" class="addCartBtn" href="javascript:;" onclick="AjaxAddCart(<?php echo $vo[goods_id]; ?>,$('#num_'+<?php echo $vo[goods_id]; ?>).val());">加入购物车</a>

                            <input value="1" id="num_<?php echo $vo[goods_id]; ?>" class="cnt" type="text" style="float:right;" />
    ...
    function ajaxSourchSubmit(tab) {
        ...
        if(tab == 0){
         ...
         $.ajax({
             ...
             url: "<?php echo U('Home/Goods/ajaxtimeLimitShop',array(),''); ?>"+"/p/" + page+"/type/"+tab,
