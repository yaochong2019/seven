<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/goods/goodsList.html";i:1543380356;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
          ...
          <thead>
            <tr>
              ...
              <th align="left" abbr="ac_id" axis="col4" class="">
                <div style="text-align: left; width: 240px;" class="" onClick="sort('goods_name');">商品名称</div>
              </th>			  <th>                <div style="text-align: left; width: 60px;" class="" >是否国内</div>              </th>
              ...
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 60px;" class="" onClick="sort('group_price2');">二人团价格</div>
              </th>
              <th align="center" abbr="article_time" axis="col6" class="">
                <div style="text-align: center; width: 60px;" class="" onClick="sort('group_price3');">三人团价格</div>
              </th>                 
              <th align="center" abbr="article_time" axis="col6" class="">
