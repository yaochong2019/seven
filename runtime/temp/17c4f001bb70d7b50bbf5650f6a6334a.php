<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/admin/view/goods/ajaxGoodsList.html";i:1543380656;}*/ ?>
<table>
       <tbody>
            <?php if(is_array($goodsList) || $goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
			 ...
			 <td class="handle" >
                ...
                <td align="center" axis="col0">
                  <div style="text-align: left; width: 240px;"><?php if($list[is_virtual] == 1): ?><span class="type-virtual" title="虚拟兑换商品">虚拟</span><?php endif; ?><?php echo getSubstr($list['goods_name'],0,33); ?></div>
                </td>				<td align="center">                  <div style="width: 60px;">					<?php if($list['flag_china'] == 1): ?>国内<?php else: ?>国外<?php endif; ?>				  </div>		                </td> 
                <td align="center" axis="col0">
                ...
                <td align="center" axis="col0">
                  <div style="text-align: center; width: 60px;"><?php echo $list['group_price2']; ?></div>
                </td>
                <td align="center" axis="col0">
                  <div style="text-align: center; width: 60px;"><?php echo $list['group_price3']; ?></div>
                </td>       
                <td align="center" axis="col0">
