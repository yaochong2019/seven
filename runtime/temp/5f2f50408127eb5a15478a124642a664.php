<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view/order/return_list.html";i:1528077548;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript">
	...
	function ajax_get_table(tab,page){
	    cur_page = page; //当前页面 保存为全局变量
	        $.ajax({
	            type : "POST",
	            url:"/Admin/order/ajax_return_list/p/"+page,//+tab,
