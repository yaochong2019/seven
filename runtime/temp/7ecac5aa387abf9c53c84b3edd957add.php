<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/pc/jinghui/user/index.html";i:1542613228;s:40:"./template/pc/jinghui/public/header.html";i:1542287950;s:42:"./template/pc/jinghui/public/left_nav.html";i:1542288714;s:40:"./template/pc/jinghui/public/footer.html";i:1534148398;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
	...
	<div class="member clearfix">
		...
		<div class="member-right">
			...
			<div class="right-cont">
				<div class="account-item account-item-special">
					<div class="item-title">
						<span>基本信息</span>
						<a class="editBasicMsg" href="javascript:;">更改信息 <i class="iconfont icon-more"></i></a>
					</div>
					<div class="item-text">
						<table class="table">
							<tr>
								<td>
									<div class="t-head">头像</div>
									<div class="t-text" style="padding:2px 10px;"><img src="<?php echo (isset($user['head_pic']) && ($user['head_pic'] !== '')?$user['head_pic']:'__STATIC__/images/my.png'); ?>"
									width="auto" height="40" style="margin-top:5px;"></div>
								</td>
								<td>
									<div class="t-head">账户名</div>
									<div class="t-text"><?php echo $user['username']; ?></div>
								</td>
								<td>
									<div class="t-head">姓名</div>
									<div class="t-text"><?php echo $user['nickname']; ?></div>
								</td>
								<td>
									<div class="t-head">电子邮箱</div>
									<div class="t-text"><?php echo $user['email']; ?></div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="t-head">手机号码</div>
									<div class="t-text"><?php echo $user['mobile']; ?></div>
								</td>
								<td>
									<div class="t-head">生日</div>
									<div class="t-text"><?php if($user['birthday'] > 0): ?><?php echo date('Y-m-d',$user['birthday']); endif; ?></div>
								</td>
								<td>
				...
				<div class="account-item  account-item-special">
					<div class="item-title">
						<span>安全信息</span>
						<a class="editBasicMsg2" href="javascript:;">更改信息 <i class="iconfont icon-more"></i></a>
					</div>
					<div class="item-text">
						<table class="table">
							<tr>
								<td>
									<div class="t-head">居住地</div>
									<div class="t-text"><?php echo isset($user['my_address']) ? $user['my_address'] :  '未设置'; ?></div>
								</td>
								<td>
									<div class="t-head">登录密码</div>
									<div class="t-text">******</div>
								</td>
								<td>
									<div class="t-head">支付密码</div>
									<div class="t-text"><?php if($user['paypwd']): ?>******<?php else: ?>未设置<?php endif; ?></div>
								</td>
								<td>
									<div class="t-head">绑定手机</div>
									<div class="t-text"><?php echo substr($user['mobile'],0,3); ?>****<?php echo substr($user['mobile'],-4); ?></div>
								</td>
							</tr>
							<tr>
								<td>
									<div class="t-head">密保信息</div>
									<div class="t-text">已设置</div>
								</td>
								<td>
									<div class="t-head">身份认证</div>
									<div class="t-text"><?php if($user['usercode']): ?>已认证<?php else: ?>未认证<?php endif; ?></div>
								</td>
								<td>
									<div class="t-head"></div>
									<div class="t-text"></div>
