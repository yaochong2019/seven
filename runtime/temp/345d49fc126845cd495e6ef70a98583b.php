<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view/order/delivery_list.html";i:1528077548;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
 ...
 // ajax 抓取页面
    function ajax_get_table(tab,page){
        cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/Admin/order/ajaxdelivery/p/"+page,//+tab,
