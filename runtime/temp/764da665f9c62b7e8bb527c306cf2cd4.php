<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"./application/admin/view/sms_template/_sms_template.html";i:1522351664;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="addEditSmsTemplate" method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea id="tpl_content" name="tpl_content" class="tarea" rows="6" readonly="readonly"><?php echo $smsTpl['tpl_content']; ?></textarea>
        ...
        <input type="hidden" name="tpl_id" value="<?php echo $smsTpl['tpl_id']; ?>"></label>
    </form>
</div>
<script type="text/javascript">
