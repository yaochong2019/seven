<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/plugin/index.html";i:1528077548;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <!-- li><a href="http://www.jh-shop.cc/articleList_cat_id_30.html" target="_blank"><span>云插件</span></a></li -->
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
    ...
    <div class="flexigrid">
        ...
        <div class="tDiv" style="display: none">
            <div class="tDiv2">
                <div class="fbutton"> <a href="/Admin/Plugin/add_shipping">
