<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view/comment/index.html";i:1528077548;s:43:"./application/admin/view/public/layout.html";i:1522351662;}*/ ?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript">
	...
	function ajax_get_table(tab,page){
        ...
        $.ajax({
            type : "POST",
            url:"/Admin/Comment/ajaxindex/p/"+page,//+tab,
