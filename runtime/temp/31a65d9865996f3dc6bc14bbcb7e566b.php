<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"./template/pc/jinghui/goods/country.html";i:1527171082;s:40:"./template/pc/jinghui/public/header.html";i:1542287950;s:40:"./template/pc/jinghui/public/footer.html";i:1534148398;}*/ ?>
<!DOCTYPE html>
...
<div class="container location">
	...
	<a href="<?php echo U('Home/Goods/country',array('id'=>$goods_country['id'])); ?>"><?php echo $goods_country['name']; ?>馆</a>
			...
			<div class="product-item">
				...
				<a href="<?php echo U('/Home/Goods/goodsInfo',array('id'=>$v[goods_id])); ?>">
					...
					<div class="product-name">
						...
						<?php echo getSubstr($v[goods_name],0,15); ?>
