<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/pc/jinghui/cart/index.html";i:1542615124;s:40:"./template/pc/jinghui/public/header.html";i:1542287950;s:42:"./template/pc/jinghui/public/left_nav.html";i:1542288714;s:40:"./template/pc/jinghui/public/footer.html";i:1534148398;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="member-right">
        ...
        <?php if(!(empty($cartList) || (($cartList instanceof \think\Collection || $cartList instanceof \think\Paginator ) && $cartList->isEmpty()))): ?>
            <div class="right-cont">
                <div class="account-item">
                    <div class="item-title">
                        <span>已保存收获地址<em>(共<?php echo $address_num; ?>条)</em></span>
                        ...
                        <div class="cart-list-cont">
                            <div class="cart-list-item item-single" id="edge_<?php echo $cart['id']; ?>">
                                <div class="cart-list-item-title" style="">
                                    ...
                                    <span class="store-name" style="font-size: 18px;"><?php echo $cart['goods_country']['name']; ?>馆</span>
                                </div>
                                ...
                                <table class="table product-list">
                                    ...
                                    <tr>
                                        <td width="60">
                                            <input type="checkbox" class="single-check checkCart checkCartItem " name="checkItem" value="<?php echo $cart['id']; ?>" <?php if($cart[selected] == 1): ?>checked="checked"<?php endif; ?>/>
                                        </td>
                                        <td width="110">
                                        ...
                                        <td class="text-left">
                                            <div class="product-name"><a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$cart[goods_id])); ?>"><?php echo $cart['goods_name']; ?></a>
                                        ...
                                        <td width="180">
                                            <div class="product-num ">
                                                <div class="count-number quantity-form" data-price="<?php echo $cart['goods_price']; ?>">
                                                    <a href="javascript:;" class="minus-btn decrement" onClick=""><i class="iconfont">-</i></a>
                                                    <input type="text" class="number" name="changeQuantity_<?php echo $cart['id']; ?>" type="text" id="changeQuantity_<?php echo $cart['id']; ?>" value="<?php echo $cart['goods_num']; ?>"/>
                                        ...
                                        <td width="120">
                                            <div class="cart-handle">
                                                <div class="delete">
                                                    <a class="deleteGoods" data-cart-id="<?php echo $cart['id']; ?>" href="javascript:void(0);"><i class="iconfont"></i> 删除</a>
                                                </div>
                                                <div class="collect">
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="simple-word total-prices">
                                                商品应付总计：<span id="total_prices_<?php echo $cart['id']; ?>">￥<?php echo $cart['goods_fee']; ?></span>   &nbsp;&nbsp;预估税费：￥<?php echo $cart['goods']['tax_price']; ?>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
                        ...
                        <table class="table cart-footer">
                            ...
                            <tr>
                                ...
                                <th>
                                    <div class="cart-word">
                                        <div class="top">
                                            已选商品 <span id="goods_num" style="margin-right:20px;"><?php echo $total_price['total_fee']; ?></span>   总价（不含运费）：<span id="total_fee">$<?php echo $total_price['total_fee']; ?></span>
                                        </div>
                                        <div class="bottom">
                                            商品应付总计：<b id="xctotal" style="color: #828282;font-weight:normal;margin-right:20px;">￥<em id="payables">0.00</em></b><span><?php echo $total_price['total_fee']; ?></span>商品税费(不含运费税)：￥<span id="shuifei"><?php echo $total_price['tax_price']; ?></span>
                                        </div>
                                    </div>
                                </th>
            ...
            <p <?php if(empty($cartList) || (($cartList instanceof \think\Collection || $cartList instanceof \think\Paginator ) && $cartList->isEmpty())): ?>style="text-align:center;width: 800px;"<?php else: ?>style="display: none"<?php endif; ?>>
            <a href="/">
