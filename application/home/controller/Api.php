...
class Api extends Base {
    ...
    public function get_country(){
        $parent_id = I('get.parent_id/d'); // 商品分类 父id
            $list = M('goods_country')->where("parent_id", $parent_id)->select();
    ...
    public function send_validate_code(){
        ...
        $mobile = I('mobile')?I('mobile'):I('username');
        $sender = I('send');
     ...
     * 验证短信验证码: APP/WAP/PC 共用发送方法
     */
    public function new_check_validate_code(){
    ...
    public function ad_show()
    {
        ...
        $ad = D("ad")->where($where)->order("orderby desc")->cache(true,JHSHOP_CACHE_TIME)->find();
        $this->assign('ad',$ad);
        return $this->fetch();
    }
    /**
