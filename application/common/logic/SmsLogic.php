...
class SmsLogic 
{
    ...
    {
        $smsParam = json_decode($smsParam,1);
        $content = '尊敬的用户，您的验证码是：'.$smsParam['code'].'，10分钟内有效，请尽快完成验证！';
        if(!$content || !$mobile){
            return false;
        }
        //$content = $content;
        ...
        //序列号
        $post_data['name'] = 'ala2sc';
        //密码
        $post_data['pwd'] = '7CBB4E8360DE6912D72DB782AA1D';
        //内容
        $post_data['content'] = $content;
        //手机号
        $post_data['mobile'] = $mobile;
        $post_data['type'] = 'pt';
        //定时发送，输入格式YYYYMMDDHHmmss的日期值
        //$post_data['sendTime'] = '';
        //接入码
        $post_data['sign'] = '阿拉好车';
     ...
     */
    private function sendSmsByAlidayu_old($mobile, $smsSign, $smsParam, $templateCode)
    {
        //时区设置：亚洲/上海
